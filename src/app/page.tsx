        ...
        <div className="relative z-10 container mx-auto px-4 md:px-6">
          <div className="max-w-3xl mx-auto text-center">
            <motion.div custom={0} variants={fadeUpVariants} initial="hidden" animate="visible" className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/[0.03] border border-white/[0.08] mb-8 md:mb-12">
              ...
              <span className="text-sm text-white/60 tracking-wide">Web Tabanlı Veritabanı İstemcisi</span>
            </motion.div>
            <motion.div custom={1} variants={fadeUpVariants} initial="hidden" animate="visible">
              <h1 className="text-4xl sm:text-6xl md:text-8xl font-bold mb-6 md:mb-8 tracking-tight">
                <span className="bg-clip-text text-transparent bg-gradient-to-b from-white to-white/80">Veritabanı</span>
                <br />
                <span className="bg-clip-text text-transparent bg-gradient-to-r from-indigo-300 via-white/90 to-rose-300">Deneyimini Modernleştir</span>
              </h1>
            </motion.div>
            <motion.div custom={2} variants={fadeUpVariants} initial="hidden" animate="visible">
              <p className="text-base sm:text-lg md:text-xl text-white/40 mb-8 leading-relaxed font-light tracking-wide max-w-xl mx-auto px-4">Tarayıcıdan yönetilen, şifreli, hızlı ve kullanıcı dostu veritabanı istemcisi. Ekipler ve bireyler için ideal.</p>
              <div className="flex justify-center gap-4">
                ...
                <Button variant="ghost" size="lg" onClick={() => router.push('/pricing')}>
                  Fiyatlandırmayı Gör
                </Button>
              </div>
            </motion.div>
