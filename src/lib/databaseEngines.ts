...
export const DATABASE_ENGINES: DatabaseEngineDefinition[] = [
  {
    id: 'mysql', label: 'MySQL', family: 'mysql', description: 'Oracle MySQL Community ve Enterprise',
  ...
  {
    id: 'mariadb', label: 'MariaDB', family: 'mysql', description: 'MariaDB Community ve Enterprise',
    defaultPort: 3306, defaultVersion: '11.8', versions: ['12.3', '12.2', '11.8', '11.4', '10.11', '10.6'],
    badge: 'Community', supportsAdvancedSchema: true,
    systemDatabases: ['information_schema', 'performance_schema', 'sys', 'mysql']
  },
  {
    id: 'tidb', label: 'TiDB', family: 'mysql', description: 'MySQL protokolü uyumlu dağıtık SQL',
  ...
  {
    id: 'postgresql', label: 'PostgreSQL', family: 'postgresql', description: 'PostgreSQL açık kaynak ilişkisel veritabanı',
  ...
  {
    id: 'cockroachdb', label: 'CockroachDB', family: 'postgresql', description: 'PostgreSQL protokolü uyumlu dağıtık SQL',
    defaultPort: 26257, defaultVersion: '26.2', versions: ['26.2', '26.1', '25.4', '25.3', '24.3'],
    badge: 'Distributed', supportsAdvancedSchema: false,
    systemDatabases: ['system', 'defaultdb', 'postgres']
  },
  {
    id: 'mssql', label: 'Microsoft SQL Server', family: 'mssql', description: 'SQL Server ve Azure SQL Database',
