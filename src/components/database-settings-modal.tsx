...
export function DatabaseSettingsModal({ open, onClose, initialTab = 'account' }: DatabaseSettingsModalProps) {
  ...
  ['commandPalette','Komut paleti'],['newQuery','Yeni sorgu'],['runQuery','Sorguyu çalıştır'],['formatSql','SQL biçimlendir'],['refresh','Yenile'],['insertRow','Satır ekle'],['settings','Ayarlar'],['find','Bul'],['closeTab','Sekmeyi kapat'],['duplicateTab','Sekmeyi çoğalt']
