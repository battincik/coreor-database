        ...
        <div className="min-h-0 flex-1 overflow-y-auto overscroll-contain p-3 sm:p-5 lg:p-6">
          <div className="grid min-w-0 grid-cols-1 gap-4 lg:grid-cols-[minmax(0,1fr)_430px]">
            <FormSection icon={Server} title="Sunucu bilgileri" description="Profil, ağ hedefi ve bağlantı kullanıcısı tek grupta yönetilir."><div className="grid gap-4">
              ...
              <div className="flex items-start gap-2 rounded-xl border border-emerald-500/15 bg-emerald-500/[0.04] p-3 text-[9px] leading-4 text-emerald-100"><ShieldCheck className="mt-0.5 h-3.5 w-3.5 shrink-0" />Bağlantı profili ve parola diskte yalnızca AES-256-GCM ile şifreli kasada tutulur. Cihaz anahtarı işletim sisteminin güvenli kimlik deposundadır; düzenlerken parola alanını boş bırakırsanız mevcut gizli parola korunur.</div>
            </div></FormSection>
